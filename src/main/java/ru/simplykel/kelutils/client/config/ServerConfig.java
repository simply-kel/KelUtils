...
public class ServerConfig {
    ...
    public static boolean FOLLOW_SWAP_ITEM = false;
    ...
    public static void save(){
        ...
        jsonConfig.put("SHOW_ADDRESS", SHOW_ADDRESS)
                ...
                .put("FOLLOW_SWAP_ITEM", FOLLOW_SWAP_ITEM);
        try {
    ...
    public static void load(){
        ...
        try{
            ...
            if(!jsonConfig.isNull("FOLLOW_SWAP_ITEM")) FOLLOW_SWAP_ITEM = jsonConfig.getBoolean("FOLLOW_SWAP_ITEM");
            else FOLLOW_SWAP_ITEM = false;
        } catch (Exception e){
            e.printStackTrace();
            clear();
            save();
